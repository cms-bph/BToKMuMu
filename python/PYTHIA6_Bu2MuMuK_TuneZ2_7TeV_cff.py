...
configurationMetadata = cms.untracked.PSet(
    ...
    ('$Source: /local/reps/CMSSW/CMSSW/Configuration/GenProduction/python/SevenTeV/PYTHIA6_Bu2MuMuK_TuneZ2_7TeV_cff.py,v $'),
    annotation = cms.untracked.string('B+ -> mu+ mu- K+ at 7TeV')
    )
